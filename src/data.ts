...
export const DEFAULT_CLIENTS: Client[] = [
  {
    ...
    first: 'David',
    last: 'Martinez',
    assignedBrokerId: 'u_jeffb',
    assignedBrokerName: 'Jeff Brown',
    assignedBroker: 'Jeff Brown',
    agent: 'Jeff Brown',
  ...
  },
  {
    ...
    first: 'David',
    last: 'Chen',
    assignedBrokerId: 'u_jameyb',
    assignedBrokerName: 'Jamey Brown',
    assignedBroker: 'Jamey Brown',
    agent: 'Jamey Brown',
  ...
  },
  {
    ...
    first: 'Sarah',
    last: 'Thompson',
    assignedBrokerId: 'u_jasonm',
    assignedBrokerName: 'Jason Myszkowski',
    assignedBroker: 'Jason Myszkowski',
    agent: 'Jason Myszkowski',
  ...
  },
  {
    ...
    first: 'Marcus',
    last: 'Jackson',
    assignedBrokerId: 'u_matthewb',
    assignedBrokerName: 'Matt Brown',
    assignedBroker: 'Matt Brown',
    agent: 'Matt Brown',
  ...
  },
  {
    ...
    first: 'Robert',
    last: 'Wilson',
    assignedBrokerId: 'u_waynem',
    assignedBrokerName: 'Wayne MacLeod',
    assignedBroker: 'Wayne MacLeod',
    agent: 'Wayne MacLeod',
  ...
  },
  {
    ...
    first: 'Michael',
    last: 'Harrison',
    assignedBrokerId: 'u_timb',
    assignedBrokerName: 'Tim Brown',
    assignedBroker: 'Tim Brown',
    agent: 'Tim Brown',
    ...
    condo: 0,
    heat: 140,
    addr: '45 Dunsmore Lane, Barrie ON L4M 6T1',
    proptype: 'Detached',
    tenure: 'Freehold',
    lender: 'First National',
    source: 'Referral',
    status: 'funded',
    fundedDate: new Date(Date.now() - 34 * 24 * 3600000).toISOString(),
    createdAt: new Date(Date.now() - 70 * 24 * 3600000).toISOString(),
    updatedAt: new Date(Date.now() - 34 * 24 * 3600000).toISOString()
  },
  {
    id: 'c_bekker',
    first: 'Anika',
    ...
    condo: 0,
    heat: 130,
    addr: '12 Bayview Drive, Barrie ON L4N 4Y8',
    proptype: 'Townhouse',
    tenure: 'Freehold',
    lender: 'MCAP',
    source: 'Website Form',
    status: 'funded',
    fundedDate: new Date(Date.now() - 65 * 24 * 3600000).toISOString(),
    createdAt: new Date(Date.now() - 95 * 24 * 3600000).toISOString(),
    updatedAt: new Date(Date.now() - 65 * 24 * 3600000).toISOString()
  },
  {
    id: 'c_alvarez',
    first: 'Carlos',
    ...
    condo: 0,
    heat: 160,
    addr: '89 Maple Avenue, Orillia ON L3V 2B4',
    proptype: 'Detached',
    tenure: 'Freehold',
    lender: 'Scotiabank',
    source: 'Referral',
    status: 'funded',
    fundedDate: new Date(Date.now() - 98 * 24 * 3600000).toISOString(),
    createdAt: new Date(Date.now() - 130 * 24 * 3600000).toISOString(),
    updatedAt: new Date(Date.now() - 98 * 24 * 3600000).toISOString()
  },
  {
    id: 'c_dupuis',
    first: 'Claire',
    last: 'Dupuis',
    assignedBrokerId: 'u_david',
    assignedBrokerName: 'David Acosta',
    assignedBroker: 'David Acosta',
    agent: 'David Acosta',
    email: 'cdupuis@gmail.com',
    cell: '(705) 555-1102',
    dob: '1987-09-02',
    marital: 'Single',
    sin: '7721',
    ...
    condo: 210,
    heat: 110,
    addr: '304-150 Dunlop St E, Barrie ON L4M 6H1',
    proptype: 'Condo',
    tenure: 'Condo',
    lender: 'TD Canada Trust',
    source: 'Google Search',
    status: 'funded',
    fundedDate: new Date(Date.now() - 128 * 24 * 3600000).toISOString(),
    createdAt: new Date(Date.now() - 160 * 24 * 3600000).toISOString(),
    updatedAt: new Date(Date.now() - 128 * 24 * 3600000).toISOString()
  }
];
